...
def load_checkpoint(cfg: CheckpointConfig, trainer, **passthrough_args):
    ...
    *passthrough_args* will be passed through to
    ...
    # print('check epoch_itr here ... ')
    # print("trainer.task.datasets['valid']: lables, targets, start_boundary_idx, end_boundary_idx")
    ...
    # import pdb;pdb.set_trace()    # check what are in the batch
    # epoch_itr.batch_sampler: the idx of the data in each batch
